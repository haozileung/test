...
public class UserSaveServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        User user = UserRepository.getInstance().load(Long.valueOf(requestMap.get("id")[0]));
        try {
        ...
        user.setPassword(Hashing.sha512().hashString(user.getPassword(), Charsets.UTF_8).toString());
