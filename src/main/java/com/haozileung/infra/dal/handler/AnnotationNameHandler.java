 ...
 * 默认名称处理handler
 */
public class AnnotationNameHandler implements NameHandler {

    private Map<Class<?>, Map<String, String>> nameMap = Maps.newConcurrentMap();
    ...
    public String getPkFieldName(Class<?> entityClass) {
        ...
        return nameMap.get(entityClass).get("_fieldName_");
    }
